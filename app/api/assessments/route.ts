...
export async function POST(request: Request) {
  ...
  await db.prepare(`INSERT INTO assessments (id, postcode, address, annual_usage_kwh, usage_source, panel_count, panel_watts, system_kwp, annual_generation_kwh, annual_bill_before, annual_bill_solar_only, annual_bill_solar_battery, annual_benefit) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`)
